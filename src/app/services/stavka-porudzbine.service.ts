...
export class StavkaPorudzbineService {
 ...
 private readonly API_URL = 'https://rvabackend.herokuapp.com/stavkaPorudzbine/';
 private readonly API_URL_BYID = 'https://rvabackend.herokuapp.com/stavkeZaPorudzbinu/';
